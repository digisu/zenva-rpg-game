...
RPG.PhysicalAttackMenuItem.prototype.select = function () {
    ...
    this.game_state.current_attack = new RPG.Attack(this.game_state, this.game_state.current_unit.name + "_attack", {x: 0, y: 0}, {group: "attacks", owner: this.game_state.current_unit});
};